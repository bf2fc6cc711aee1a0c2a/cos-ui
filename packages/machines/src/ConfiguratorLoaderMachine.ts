...
export type ConnectorConfiguratorType = ComponentType<ConnectorConfiguratorProps>;
...
>(
  {
    ...
    states: {
      ...
      success: {
        type: "final",
        data: ({ Configurator, steps }: Context) => ({ Configurator: Configurator!, steps: steps as string[] | false })
      },
    },
  }
);
